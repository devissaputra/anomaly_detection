...
This is a professor-readable AI Engineering project built around **real data**, an explicit processing mechanism, executable code, empirical evaluation, and a scientific-style technical report. It demonstrates **anomaly detection, novelty detection, Isolation Forest, ROC-AUC** without hiding the data-processing choices inside an opaque notebook.
